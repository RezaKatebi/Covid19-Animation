...
class BlueMarble(object):
    ...
    def generatemap(self,
        ...
        self.ax.scatter(df_date.Long.values, df_date.Lat.values,
                   s = scale * df_date.RevoverNorm.values,
                   transform=ccrs.PlateCarree(),
                   color = '#00a6f9',
                   alpha = 0.6
                  )
        ...
        colors = ["#ffee00", '#00a6f9', '#ff5483']
        groups = ['Confirmed', 'Death', 'Recovered']
        numbers = [df_date.Confirmed.sum(), df_date.Deaths.sum(), df_date.Recovered.sum()]
